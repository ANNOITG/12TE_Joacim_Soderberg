...
namespace WindowsFormsApplication1
{
	...
	public partial class CarListDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteRecord(Record instance);
		...
		public CarListDataContext() : 
				base(global::WindowsFormsApplication1.Properties.Settings.Default.CarsDatabaseConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public CarListDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CarListDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CarListDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CarListDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnInforChanging(string value);
    partial void OnInforChanged();
    ...
    partial void OnMembersChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Infor", DbType="VarChar(255)")]
		public string Infor
		{
			get
			{
			...
			set
			{
				if ((this._Infor != value))
				{
					this.OnInforChanging(value);
					this.SendPropertyChanging();
					this._Infor = value;
					this.SendPropertyChanged("Infor");
					this.OnInforChanged();
				}
			}
		}
